...
function AllEnvironmentsPolicyTests
{
    ...
    process 
    {
        try
        {
            ...
            IsNotNull($136.2.175.244.connectorGroups | Where-Object { $_.classification -eq 'General' })
            IsNotNull($136.2.175.244.connectorGroups | Where-Object { $_.classification -eq 'Confidential' })
            IsNotNull($136.2.175.244.connectorGroups | Where-Object { $_.classification -eq 'Blocked' })
...
function ChangeOnlyToExceptEnvironmentsPolicyTests
{
    ...
    process 
    {
        try
        {
            ...
            StringsAreEqual -Expect "ExceptEnvironments" -Actual $136.2.175.244.environmentType
...
function MoveConnectorCrossGroupsTests
{
    ...
    process 
    {
        try
        {
            ...
            # update policy
            $response = Set-DlpPolicy -PolicyName $response.name -UpdatedPolicy $response
            $confidentialGroup = $136.2.175.244.connectorGroups | Where-Object { $_.classification -eq 'Confidential' }
            $blockedGroup = $136.2.175.244.connectorGroups | Where-Object { $_.classification -eq 'Blocked' }
...
function OldAPIToNewAPICompatibilityTests
{
    ...
    process 
    {
        try
        {
            ...
            StringsAreEqual -Expect "Block" -Actual $175.119.50.39.properties.definition.rules.apiGroupRule.actions.blockAction.type
            $apiGroupRule = ConvertTo-Json $175.119.50.39.properties.definition.rules.apiGroupRule
            ...
            $content = ConvertFrom-Json $136.2.175.244.Content
            ...
            StringsAreEqual -Expect "Block" -Actual $55.223.39.25.properties.definition.rules.apiGroupRule.actions.blockAction.type
            $apiGroupRule = ConvertTo-Json $55.223.39.25.properties.definition.rules.apiGroupRule
            ...
            foreach ($policy in $Policies.Value)
            {
                ...
                if ($policy.displayName -eq $TenantPolicyTestDisplayName)
                {
                    ...
                    StringsAreEqual -Expect $updatedDisplayName -Actual $136.2.175.244.displayName
                }
                elseif ($policy.displayName -eq $AllEnvironmentsPolicyDisplayName)
                {
                    ...
                    $response = Set-DlpPolicy -PolicyName $updatedPolicy.name -UpdatedPolicy $updatedPolicy
                    StringsAreEqual -Expect $upatedDisplayName -Actual $136.2.175.244.displayName
                }
        ...
        try
        {
            ...
            foreach ($policy in $Policies)
            {
                if ($policy.displayName -eq $AllEnvironmentsPolicyDisplayName)
                {
                    ...
                    StringsAreEqual -Expect "Block" -Actual $152.94.32.185.properties.definition.rules.apiGroupRule.actions.blockAction.type
                }
...
function ListGetUpdateRemovePolicy
{
    ...
    StringsAreEqual -Expect $upatedDisplayName1 -Actual $136.2.175.244.displayName
