# Purpose: slate — General-purpose PowerShell utilities.
$css = [pscustomobject]@{
	textcolor             = [System.Drawing.Color]::WhiteSmoke
	formcolor             = [System.Drawing.Color]::DarkSlateGray
	tabcolor              = [System.Drawing.Color]::WhiteSmoke
	DeployButton          = [System.Drawing.Color]::YellowGreen
	richcolor             = [System.Drawing.Color]::DarkSlateGray
