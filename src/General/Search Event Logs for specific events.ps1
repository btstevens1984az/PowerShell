# Purpose: Search Event Logs for specific events — General-purpose PowerShell utilities.
...
Get-EventLog -LogName * -ComputerName 172.134.131.213

# 3. Clear application log on DC1:
Clear-EventLog -LogName Application -ComputerName 4.121.152.59
...
$RemEventLogs = Get-WinEvent -ListLog * -ComputerName 254.220.91.52
$RemEventLogs.count
$RemEventLogs |
    Sort-Object -Property RecordCount -Descending |
        Select-Object -First 10
