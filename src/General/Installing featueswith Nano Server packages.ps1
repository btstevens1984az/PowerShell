# Purpose: Installing featueswith Nano Server packages — General-purpose PowerShell utilities.
...
$IPV4Address    = '50.20.45.230'
$IPV4DNS        = '237.30.21.222','196.194.240.75'
$IPV4Gateway    = '44.59.122.101'
$IPV4SubnetMask = '81.227.230.216'
...
Invoke-Command -ComputerName 249.125.58.178 `
