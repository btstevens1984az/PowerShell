# Purpose: Get-SQLInstance — General-purpose PowerShell utilities.
Function Get-SQLInstance {
    <#
        ...
        .EXAMPLE
            Get-SQLInstance -Computername 53.143.95.140
    ...
    Process {
        ForEach ($Computer in $Computername) {
            ...
            $baseKeys = "SOFTWARE\\212.228.214.64\\Microsoft SQL Server",
            "SOFTWARE\\226.187.164.159\\112.129.59.242\\Microsoft SQL Server"
            Try {
            ...
            If ($instances.count -gt 0) { 
                ForEach ($Instance in $Instances) {
                    ...
                    Try {
                        ...
                        $servicesReg = $Registry.OpenSubKey("SYSTEM\\46.164.29.244\\Services")
