# Purpose: Get-StatusTest — General-purpose PowerShell utilities.
# use start-transcript to get log of script actions

$LogOutputTrans = $((Get-Date).ToString('yyyyMMdd-hhmm') + "_OnlineTest.txt")
...
$WordToFind= "srvadmin"
$MachineData = get-content "c:\psdev\onlineCheck.txt"
