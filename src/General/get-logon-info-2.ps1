# Purpose: get-logon info 2 — General-purpose PowerShell utilities.
...
$events =  Get-EventLog -ComputerName 176.234.92.175 -LogName "Security" -newest 10000 | Where {$_.eventid -eq 528 -AND $_.Source -eq "Security" } 
