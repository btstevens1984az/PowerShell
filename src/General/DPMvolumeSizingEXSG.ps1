# Purpose: DPMvolumeSizingEXSG — General-purpose PowerShell utilities.
# Date   : 2/1/2008
#		
...
#
$sg=get-storagegroup		# get storage group for logfolderpath information
$mdb=get-mailboxdatabase		# get mailboxdata base for complete edb file spec
#
$sglist=$sg | foreach-object -process {$_.servername + "\" + $_.name}	#create server list to loop through

#loop through all servers
for ($i=0; $i -lt $sglist.count; $i++) {
	write-host -nonewline "Processing -> " $sglist[$i] "..."		#tell what we are doing
        	$dbpath=$mdb | where-object {$_.storagegroup -match $sg[$i].name}	#find edbfile for server in list
        	$edbunc="\\"+ $sg[$i].servername + "\"+ $dbpath.edbfilepath		#build UNC path to edbfile
        	$edbunc=$edbunc -replace(":","$")					#   ,,
        	$edbsiz=(get-item $edbunc).length					# get edb size
        
	# build unc path to into collecting file info's
	$logunc="\\"+ $sg[$i].servername + "\"+ $sg[$i].logfolderpath + "\*.log"	
	...
	$wmi = (get-wmiobject -query "select * from win32_logicaldisk where Size > 1" -computer $sg[$i].servername)
	$drive=$wmi | where-object {$_.DeviceID -match $sg[$i].systemfolderpath.drivename}
	...
	$drive=$wmi | where-object {$_.DeviceID -match $sg[$i].logfolderpath.drivename}
	if ($drive.freespace/$oneGB -gt 1) 
	{
		$FlagReasons=$FlagReasons + $drive.DeviceID + " =<1GB "
		$FlagBad="TRUE"
	...
	$line= $FlagBad +  "`t" + $FlagReasons +  "`t" + $sglist[$i] + "`t" + ($edbsiz/$oneGB) + "`t" + ($t/$oneMB)
...
# MIIkLQYJKoZIhvcNAQcCoIIkHjCCJBoCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQu6AE0nDiDTUaHIZ2MbkeX+n
# G8Gggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# OAIch6wGxZYyuOVAxlM9vamJ3uhmN430IpaczLB3VFE61nJEsiP2MYIEtjCCBLIC
...
# Kw4DAhoFAKCB4TAZBgkqhkiG9w0BCQMxDAYKKwYBBAGCNwIBBDAcBgorBgEEAYI3
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUxo25S/n7dNUse2t6
# iZNnrGVtf/gwgYAGCisGAQQBgjcCAQwxcjBwoE6ATABNAGkAYwByAG8AcwBvAGYA
# dAAgAEQAYQB0AGEAIABQAHIAbwB0AGUAYwB0AGkAbwBuACAATQBhAG4AYQBnAGUA
# cgAgADIAMAAwADehHoAcaHR0cDovL3d3dy5taWNyb3NvZnQuY29tL0RQTTANBgkq
# hkiG9w0BAQEFAASCAQCXapbp5uGpLR5zhP7hFvAKibyWOE+WwsaKCIRh2M2gKUDI
# tus6GqAq88fQFHoc71ITbwj0Vc+w3I6c6G2pEtbkSLRuQ3ClQoqF/9ceD9oj8oFY
# krpL8VVrJofyckSaqb6SdUvefhrvkVKGBlIR2JEenza2yxqL0KXOKLHN37lOoQbZ
# hGJLwZjlS94p4emQ8N2OlmiH01pEI2W/VYdmYjpWAM6RNxvDV59/g1alpcjAjnYg
# FJr9Jf3sG9ne+PpUwNuoGy2l86AND4nl9IGJ0berneXoHZcDkTdFCjSTgwjI1nco
# 4b+/Mc+Ew2d+F5rzvqVq6yThgVvU1iiXtkWctZ4moYICHzCCAhsGCSqGSIb3DQEJ
# BjGCAgwwggIIAgEBMIGHMHkxCzAJBgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5n
# dG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9y
# YXRpb24xIzAhBgNVBAMTGk1pY3Jvc29mdCBUaW1lc3RhbXBpbmcgUENBAgphR1K6
# AAAAAAAEMAcGBSsOAwIaoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEHATAcBgkq
# hkiG9w0BCQUxDxcNMDgwNDI5MDY1NDIzWjAjBgkqhkiG9w0BCQQxFgQUJUC5pbbL
# fvcQWvXt7pgmD1UzdW4wDQYJKoZIhvcNAQEFBQAEggEAHnBvfsNggIHJ5X1srOqd
# EnkqxzGwWk6NfdTOm18pyEMkCBS7PIYHGuc//ofRJRtIr7F6wtE8KwKX3PoLDe8S
# ZdTHnAmxYFyf9mwOJWbqSBSI91F02iKFERvc5Mu/2eNoCB4+1mj/AEuq2vdXtGeQ
# V3edTwJDc4Dq51E3np5GAKhJdIrggkr+JboaFeQ5al5A0nXszwGQEru3qERHuWFV
# TQOqdIZuMndtEt8Lk9K/PcKgBwA1oaI9K9UbKLviioCD/TvvTOzcgSYFt2Mw+k9y
# tG04zxzH94v8E+V6PoTbu2NJidorxGyt46dSV4EGLCUuerhGebZiV0wYkil45CIp
# uw==
