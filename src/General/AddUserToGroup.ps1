# Purpose: AddUserToGroup — General-purpose PowerShell utilities.
...
@"
 ...
 Displays error and prints out help
 ...
 AddUserToGroup.ps1 -name "cn=MyNewUser" -ou "ou=myOU" `
               -dc "dc=nwtraders,dc=com" `
               -group "cn=MyGroup" -whatif
 
 Displays what if: Perform operation add user to group. User name cn=MyNewUser
 in OU ou=myOU domain dc=nwtraders,dc=com group cn=MyGroup

 AddUserToGroup.ps1 -help

 Prints the help topic for the script

 AddUserToGroup.ps1 -help -full

 Prints full help topic for the script

 AddUserToGroup.ps1 -help -examples

 Prints only the examples for the script

 AddUserToGroup.ps1 -examples
...
Function funWhatIf()
{
 "what if: Perform operation add user to group. User name $name, group
  in OU $ou domain $dc group $group"
 exit
} #end funWhatIf

Function funAddUserToGroup()
{
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUc6RAsOy/M64HaB77wiv/HJ5G
# AxKggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUvMmn+C9HutyOqrFj
# G1ad14Gws1UwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAnG7+FG9spTC0rjWdMSFpWBhrkFKl
# jceWlnX5oicp7SwCagB7iHMyrzP5j6aD2rnHhof1P3es2arOS141sNvj2S4VGC/h
# pZlEh6Otlfwmw/CLtDEhJmYYhrk2OPjl2ezmYV6FbhrCIvFzg8QTFfLuGz8dfTbl
# ISNJLTyW8jUvqH2KoARvqz6Bnmv1tq2fgPqlZNypCZqnzipAhnEWgW8lykh6qAd/
# kC4c/pyQ5lrFhnYOrT07kyhZQRu1Xnb/d99HmUMDOKKxQekvs/TlAQyw9fpGkwBa
# iiBRtYyCf6MLpyONRydJcP/JJXY2EQf0Jo5AwaXvC7RqCbCxNLNnNNCuTaGCAh8w
...
# AQkEMRYEFEeP7M8pbxNbgvoxjDM1nQdlnvsOMA0GCSqGSIb3DQEBBQUABIIBACoe
# ynw+gdmHvWDpi3Y9lt9MdaJKrFHr17WEz0doOiAm2BK0ngFSWXFRH8/UJqqnpDvX
# 3eL4cpO6tOftmvhwSUz0jFV8aPXLHye6ncOMqSzd4ZwqzPmwdc+Qa1XdcmpN8BL4
# 8YQMY6CnC5auzJkyVaY0GGU2usNfkuovF1DBAhcKTyW0jjQqFWD30AWxtDN8qFTT
# dQ19KmOWl6gcGFVhlSCo+rsGL62bnm33gLYBM9nsfLVGi5IR5rVeuQjhYCuKjX05
# zlW8NMWvxeGrqXp8FkunIh+XjBmx5hGiwXrK+M5Pdp/j8PrZWQOzMaIwvBnxK5wm
# Z+c7UniCtluzArwdF8A=
