# Purpose: Get-BLAgentInfoWithLogWithCopy — General-purpose PowerShell utilities.
...
#	
		...
		# doesnt check for admin sid ending in 500 which indicates admin	#domain controllers doNT use have local accounts
