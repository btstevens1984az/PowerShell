# Purpose: getUserSid — General-purpose PowerShell utilities.
$root=[ADSI]"LDAP://CN=Users,DC=Discovery,DC=Sanderson"
  $search=[System.DirectoryServices.DirectorySearcher]$root
  $Search.Filter="(&(objectcategory=User))"
  $result=$search.FindAll()
#Try {del .\Users.txt} 
#Catch {Continue} 
"Logon Name|User Name|SID" > .\Users.txt
...
#                write-host  ("    OU=",$OU)  
       ...
       $SID= $User.properties.objectSid | out-string -stream
   } 
    -join ($LogonName, "|", $UserName, "|", $OU, "|", $pwdlastset, "|", $LastLogon, "|", $SID) >> .\Users.txt  
 }
