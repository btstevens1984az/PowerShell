...
# Function:          Package-LatestChrome
# 
# For help, please type "Get-Help InstallationDir\Package-LatestChrome.ps1
#
#########################################################################################
...
.DESCRIPTION 
    ...
    All are bound together by the main function Package-LatestChrome
    File Name  : Package-LatestChrome.ps1
