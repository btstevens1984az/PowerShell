# Purpose: QueryAD — General-purpose PowerShell utilities.
...
@"
 ...
 QueryAD.ps1 -domain "nwtraders.com" 

 Displays a listing of every object in the nwtraders.com domain

 QueryAD.ps1 -domain "nwtraders.com" -ou "mytestou" -query user

 Displays a listing of user objects in the mytestou organizational
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGE/r7V+49DJwUppOItSuvIZd
# bEqggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUL95i7WfwF4yS+The
# TMkPhOo1vtMwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAQDlHHHQAjBrdYrg55+6fBolAz5sa
# H7GOC0g35O5M20MQcbL3iejc8YXdN5KnqCAp91VFb93q69FfPuMjbK8Im6FkAxEJ
# bUIAKKHePSIOnEnOx+goY90HXc4iL3AyYxrhnWdz1qU4qK0i+nbEGoNiFoZBxS9G
# yhUxU3m7J4eFGzpB3dixHTNLoxBHvSOLcdHLCa8ScUDNo0Jx1SyA1iWZr1fJDav4
# jLlZCTSDwt8WBdMRVmfHi7hHS1JoxWuatFoVYPfvZ2JfSp5HMbxVGNPTAyo19qfc
# /CeP3IVj9C49FgpXQ1VFw2r9YbifYuEaSm8Br11t/eCA1NKgaMHf5gpSaqGCAh8w
...
# AQkEMRYEFA3OnrJgnIJuInVdyYupsxrf3Tc/MA0GCSqGSIb3DQEBBQUABIIBAAh3
# XuJXFEy+V7FY5MKOHp8SzMTQ4z8q/h+6FWOj4W0bh3oJzxdxLCFrnM1jWBua/kJj
# vloCNIWFmEqjObNbtw1E4VubZITXKETWhdWe9Mjhr+R6VpCd/jIeVWtX1/1U4TSi
# ZXQ8TGvk7IkqsEZXGKuE5I1C2dCZinDXhABTFHp1jxumvxbtcO/RDo4TxVMSOM0I
# 1spkTb9/ou7R8izUALHqFsa3wAfZsnV+HHz/T3HFeluii6zpVj/1mcnK37qARNlC
# DEpvAzRNfn2i5T0ESYAt3TuQxmNSnvbolgwLcKgWFhxOER9Okq88hKVNzsNspwdm
# 75GchmHazv506MtBB6o=
