# Purpose: Using BPA — General-purpose PowerShell utilities.
# Recipe 8-3 - Using BPA
...
Invoke-Command -ComputerName 4.121.152.59 -ScriptBlock {Get-BpaModel} |
    Format-Table -Property Name, Id

# 9. Run BPA Analyzer on BTS-WIN10PRO
...
$RRESULTS = Invoke-Command -ComputerName 4.121.152.59 -ScriptBlock $sb
