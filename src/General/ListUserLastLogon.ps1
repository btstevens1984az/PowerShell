# Purpose: ListUserLastLogon — General-purpose PowerShell utilities.
...
@"
 ...
 ListUserLastLogon.ps1  -users mytestuser -domain 229.39.80.135
 ...
 ListUserLastLogon.ps1 -help

 Prints the help topic for the script

 ListUserLastLogon.ps1 -help -full

 Prints full help topic for the script

 ListUserLastLogon.ps1 -help -examples

 Prints only the examples for the script

 ListUserLastLogon.ps1 -examples
...
if(!$users -and !$all) { funhelp }

# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvmXxcXwKsIlw9Rc7KJypXPya
# V/aggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUyXHKgTItGqujQYZc
# 3jRk2KWhXVowXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEADLje6EW+hcXH9WNPNoqKLkoHTNCH
# Mkf1aAEfdGdfHsP9s75qwr2uYI/IWsHVW6CI9ABdFpCkBW2oHytFevXPXpWty5KC
# 2svVNjWHL6sW/nvJ/90iCkIZ66kdFCjP8omPbfNfhDHwWO7zimWFZ6mijX8j92lm
# ft4jCcvr9rYGo9o+XJJG5gmfuMhprxLEha9jcMNj3jhXh+mL23jHlropsOrIuzad
# COkKvz6xZiDlKBs6lTV7qqi8h4EkAH/lYFVe68YfMEtJVObqEo9/OY87Zm0gv21q
# LTaoxijJ1CzPR1yVNzXNC3/7baRBF1fGl2v4nWPResq2NPMc32OXVLgKW6GCAh8w
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MDIwODIwMDQwMVowIwYJKoZIhvcN
# AQkEMRYEFKpFZ16Ek2qs4Bg+Ysl9fB9pAuglMA0GCSqGSIb3DQEBBQUABIIBAIXR
# xMhNJwvISNRZrSu/WWF4OYDCTW7NzUBHh09yVpSOS4UVB10ETXLFsdPilqniqFpW
# FlrRZECffZcIOt2Vlnr9f1jCDfLYg65o6+itE8BhpS+g4n5orQ7AG0gPEaKEeL4z
# oqE/m9Tz6YvjtNlOs72hCh8mzyX751edO3/wXeFuTMZX0OX1nmYDHbQ2H0WGguIt
# xMC6eMXePpmHpj85Cfo9yyrSK+gGx56bmDptsnPe4BKd145EoW42i5SpsprEu99m
# TrsLZ0th1WK8xWJXOZ3FJK9pmEP04JLfxYo5Fa9CQVIlDyMWXrQeXlQybdgonIiC
# uMs5K0i2I/BK2k6czaQ=
