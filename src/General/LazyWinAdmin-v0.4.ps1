# Purpose: LazyWinAdmin — General-purpose PowerShell utilities.
...
#region Call-Global_ps1
	...
	function Set-RDPEnable ($ComputerName = '.') {
		    ...
		    $regKey = $regKey.OpenSubKey("SYSTEM\\46.164.29.244\\171.201.54.20\\Terminal Server" ,$True)
	...
	function Get-PageFile
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-PageFile -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-PageFileSetting
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-PageFileSetting -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-DiskPartition
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-DiskPartition -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-DiskSpace 
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-Diskspace -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-Processor
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-Processor -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-InstalledSoftware
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-InstalledSoftware -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-RegistryKey 
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-registrykey HKLM\Software\Adobe -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Get-RegistryValue
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-RegistryValue HKLM\Software\Adobe -Name State -ComputerName 161.222.128.217
	            Description
	            -----------
	        ...
	        .Example
	            Get-RegistryValue HKLM\Software\Adobe -ComputerName 161.222.128.217 -Recurse
	            Description
	            -----------
	...
	function New-RegistryKey
	{
	    ...
	    <#
	        ...
	        .Example
	            New-registrykey HKLM\Software\Adobe -Name DeleteMe -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function New-RegistryValue
	{
	    ...
	    nd Qword
	        ...
	        .Example
	            New-RegistryValue HKLM\SOFTWARE\Adobe\MyKey -Name State -Value 0 -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Remove-RegistryKey
	{
	    ...
	    <#
	        ...
	        .Example
	            Remove-RegistryKey HKLM\Software\Adobe -Name DeleteMe -ComputerName 161.222.128.217
	            Description
	            -----------
	            Removes the key called DeleteMe under HKLM\Software\Adobe on MyServer1
	            
	        .Example
	            Remove-RegistryKey HKLM\Software\Adobe -Name DeleteMe -ComputerName 161.222.128.217 -Recurse
	            Description
	            -----------
	...
	function Remove-RegistryValue 
	{
	    ...
	    <#
	        ...
	        .Example
	            Remove-RegistryValue HKLM\Software\Adobe\MyKey -Name State -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Search-Registry 
	{
	    ...
	    es.
	        ...
	        .Example
	            Search-Registry -Hive HKLM -Filter "Powershell" -Path "SOFTWARE\Clients" -computername 161.222.128.217
	            Description
	            -----------
	...
	function Set-RegistryValue
	{
	    ...
	    word
	        ...
	        .Example
	            Set-RegistryValue HKLM\SOFTWARE\Adobe\MyKey -Name State -Value 0 -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Test-RegistryKey 
	{
	    ...
	    <#
	        ...
	        .Example
	            Test-registrykey HKLM\Software\Adobe -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Test-RegistryValue
	{
	    ...
	    <#
	        ...
	        .Example
	            Test-RegistryValue HKLM\Software\Adobe -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Test-Port
	{
	    ...
	    <#
	        ...
	        .Example
	            Test-Port -tcp 3389 -ComputerName 161.222.128.217
	            Description
	            -----------
	...
	function Get-MemoryConfiguration
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-MemoryConfiguration -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-NICInfo
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-NicInfo -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-MotherBoard
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-MotherBoard -ComputerName 101.17.136.64
	            Description
	            -----------
	...
	function Get-Routetable
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-RouteTable -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-SystemType
	{
	    ...
	    <#
	        ...
	        .Example
	            Get-SystemType -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Get-RebootTime
	{
	    <#
	        ...
	        .Example
	            Get-RebootTime -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Test-KMSIsActivated 
	{
	    ...
	    <#
	        ...
	        .Example
	            Test-KMSIsActivated -ComputerName 235.154.164.181
	            Description
	            -----------
	...
	function Test-KMSSupport 
	{
	    ...
	    <#
	        ...
	        .Example
	            Test-KMSSupport -ComputerName 235.154.164.181
	            Description
	            -----------
...
function Call-MainForm_pff
{
	...
	$button_Restart_Click={
		...
		#$result = Restart-Computer 10.199.208.191 $ComputerName -Force -Confirm
		...
		{ 
			...
			Restart-Computer 10.199.208.191 $ComputerName -Force
	...
	$button_Shutdown_Click={
		...
		#$result = Stop-Computer 10.199.208.191 $ComputerName -Force -Confirm
		...
		{ 
			...
			Stop-Computer 10.199.208.191 $ComputerName -Force
