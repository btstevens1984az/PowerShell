# Purpose: Inactive — General-purpose PowerShell utilities.
...
Get-DomainComputerAccounts | Where-Object {$_.DaysSinceChange -gt 60} | sort dayssincechange | Export-CSV C:\Temp\AD.csv -NoType
