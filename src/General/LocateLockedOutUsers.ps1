# Purpose: LocateLockedOutUsers — General-purpose PowerShell utilities.
...
function funHelp()
{
 $descriptionText= `
@"
 NAME: LocateLockedOutUsers.ps1 
 DESCRIPTION:
 Locates locked out users a local or remote domain. 
 The script can run locally or remotely, and can query
...
@"
 ...
 LocateLockedOutUsers.ps1 -computer "Berlin" -query
 ...
 LocateLockedOutUsers.ps1  -help

 Prints the help topic for the script

 LocateLockedOutUsers.ps1  -help -full

 Prints full help topic for the script

 LocateLockedOutUsers.ps1  -help -examples

 Prints only the examples for the script

 LocateLockedOutUsers.ps1  -examples
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUVwvvSl02TyqowvyK00zGL7qq
# dpmggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUmtJsUqCiyHMJ8oMJ
# leGZESQwXhQwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAhSVnsB27eqlXLA4iiwh3IEHw99vB
# pb64ya3XIyj2ReS1Uj0l8OK6/1mj+MZpnmG/4aqWosyjKkx8wxVMPdVBC1XVHrPl
# ToPRfJuANubKfzU8Wo1KqLdC5wEUCCjM9DXmX24gxX72iajs+55rg7nEm2LCD2Mx
# myr4vcAkGTSRCJztz/8AV6LR1ECSUajrZPM/PkgjfOlRYMggU1zVc4A+fiKCK+Yr
# EjMR6uviKPHOMn+zABTmm6yLc+3JbZFHaB11utNyRZtGUIVcCNq0G4970x2IB3z2
# MW8TH0V57i0uUF0OdMihQGdOCQ6HqqMDnYNt6j489mij0jj4pCRznXbacaGCAh8w
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MDIwODIwMDM1N1owIwYJKoZIhvcN
# AQkEMRYEFDIlXpEROtg4pmsLxSjKBiW2VUAGMA0GCSqGSIb3DQEBBQUABIIBALEB
# SBvPHHghQhFco0z8nAKH5athSAfFMrJrYUNhIEfXthP2cxxn/JYrggQphV48iqf6
# kvWLL1JS306XT4xCqt58YbmBvHAWdKxIoGwwVDYee5Jk8me5DWRWRRAvN+WUEghj
# nkxyCbUBSNToyrhfMeBt1fIfJSH4U8/r0snTx7z30lQlNRKqLvHXW6eV14Z/sXp+
# u9Rbf57bQNXNagIaj1WJxNMmWpOkIc8MP3UikzKxZr+ld9zY16Y5t7b78C2sgyj+
# DbsW4AGExCxyytXQOaWE1u4k1YCV6ELZpGf9w9vX7SygsKPKtSbq/pimvohdbG8W
# 8McujE74WyzrgFcicws=
