# Purpose: Get-DevicesPendingReboot — General-purpose PowerShell utilities.
Function Get-DevicesPendingReboot {
# CSV variables
$csvfile = "C:\Users\$env:USERNAME\Desktop\Radia\Devices_Pending_Reboot_Report.csv"
$csvdelimiter = "`t"
