# Purpose: TSTool3 — General-purpose PowerShell utilities.
#------------------------------------------------------------------------
    ...
    $StartJob1={
        ...
        -JobScript {
            ...
            function Get-UserLogonFull
            {
               ...
               .Example
                   Get-UserLogonFull -computername 26.233.162.190 | sort-object -property @{Expression="state";Descending=$false}, @{Expression="starttime";Descending=$true} | ft computer, username, state, StartTime -auto
