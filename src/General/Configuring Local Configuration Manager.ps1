# Purpose: Configuring Local Configuration Manager — General-purpose PowerShell utilities.
...
Configuration LCMConfig
{
    Node localhost
    {
        ...
        ConfigurationRepositoryShare PullServer {
            SourcePath = '\\60.152.31.4\DSCConfiguration'
        }
        ResourceRepositoryShare ResourceServer {
            SourcePath = '\\60.152.31.4\DSCResource'
        }
    }
}
