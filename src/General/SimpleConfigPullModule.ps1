# Purpose: SimpleConfigPullModule — General-purpose PowerShell utilities.
...
configuration TestFile {
    param(
        ...
        Import-DscResource -module xDismFeature,PackageManagementProviderResource
     Node $computerName {
	    ...
	    PackageManagementSource Chrome {
		    Name                      = "GoogleChrome"
