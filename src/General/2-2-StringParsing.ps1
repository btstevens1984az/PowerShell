# Purpose: 2-2 StringParsing — General-purpose PowerShell utilities.
###############################################################################
...
#for newer operating systems and just TCP connections you can also use Get-NetTCPConnection
