# Purpose: ApprovalManager v0 8p — General-purpose PowerShell utilities.
﻿###################################################################################################################################################################
# Project: Application Approval Manager
# Date: 2-5-2013
# By: Peter van der Woude
# Version: 0.8 Public
# Usage: PowerShell.exe -ExecutionPolicy ByPass .\ApprovalManager_v0_8p.ps1 -CollectionID <CollectionID> -SiteCode <SiteCode> -SiteServer <SiteServer> -EnableAlert
###################################################################################################################################################################
[CmdletBinding()]
