# Purpose: ModifyUser — General-purpose PowerShell utilities.
...
@"
 NAME: ModifyUser.ps1
 DESCRIPTION:
 Modifies user attributes in Active Directory
...
@"
 ...
 Displays error missing parameters and calls help
 ...
 ModifyUser.ps1 -name "CN=MyNewUser" -ou "ou=myOU" `
                -dc "dc=nwtraders,dc=com" `
                -property "SamaccountName" `
                -value "MyNewUser"-whatif
 
 Displays what if: Perform operation modify user attribute SamaccountName 
 on user CN=MyNewUser in OU ou=myOU in domain dc=nwtraders,dc=com. New value 
 is MyNewUser
...
Function funWhatIf()
{
 "what if: Perform operation modify user attribute $property 
 on user $user in OU $ou in domain $dc. New value 
 is $value"
 exit
} #end funWhatIf

Function funModifyUser()
{
 $CLass = "User"
 funLine("Modifying $name,$ou,$dc")
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUoh2+y8EkSEiTTcOjwQwaxGBT
# TFiggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUmMRh4rtaGFZBaA5k
# Fq3ic/EDydEwXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEARc1yYr1RAAQ5Fx5CHExD7n2trtx7
# PaPdDO5yhzRf1AXRA1OSTOveDp3KOC8sy9PSRCm8fULXwnKhqVnlcxHcPQXfHDmo
# v9ndIUUrNAz6BhkLj9FyBbl6QGBWVjhtaIzVjj7a8OH4mulk+a0K9WteoBxvTjed
# jykodERj4BU59g4d9HYdSk8KLtiuBlyiMlSdLsAIZ+cQvXahDYF58eQ4pfMyex4O
# GJ+9u60XogzsF/5ZxEKjKbnsdHmbpkUh+0I4eEiJfGYeq3GEq5cY+B/SIVceRod2
# gEcMltBqLt9k2DxF7lXQRfb5SwOESrggcfexGhSG8w3U9zpTlh1zhqgQlqGCAh8w
...
# hkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTA4MDIwODIwMDM1MVowIwYJKoZIhvcN
# AQkEMRYEFOmJGlYVa6w372Pn66CI5vOpd0FQMA0GCSqGSIb3DQEBBQUABIIBACeD
# B5mlDGidjkhoaIdSSCp6FAqficbyVYzzxDNRpFL2z741WCG6sNpnBUrEI2vVoo4c
# E2UVvXtd+3NeWWonlc0aWdtB+y2r5Gh9I5ZnrUqOjiQdfp/C+I3PurbLG5PHyzdy
# I6kdSjwio3ByfWi3QkAL6YXDwB3gFD789CNPrzcBh+i6BJ0EJr3ISgvzZfIP2mA3
# 2dAK98TWXsWoMX6b9YWa3g6eTCUFaRTxt74ijNUq9AVwt6EE9dnjmkNrXUbY4wMr
# Cj/YV+O3O6BICmld2cuMJDdcEpQnaGVnapND1sP0h/2cboIepSqWo9zc2piH9o5C
# 7+pOHkgvfJNplcWJvM4=
