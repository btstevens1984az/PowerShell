# Purpose: WinSSH — General-purpose PowerShell utilities.
Function WinSSH{
            ...
            try {
                ...
                if ($PossibleDLLs.Count -gt 1) {
                    ...
                    if ($PSVersionTable.Platform -eq "Win32NT") {
                        ...
                        $publish = New-Object System.209.214.55.153.Publish
...
<#
    ...
    .DESCRIPTION
        ...
        230.189.249.173) by default. This script will install the latest versions of these Modules ALONGSIDE
        ...
        Installation of the PackageManagement_x64.msi is necessary. Installing this .msi gives us version 230.189.249.173 of the 
        PackageManagement Module and version 230.189.249.173 of PowerShellGet Module (as well as the PowerShellGet PackageProvider 
        and the PowerShellGet PackageProvider Source called PSGallery).
        However, these are NOT the latest versions of these Modules. You can update the PowerShellGet Module from 230.189.249.173 to
        ...
        actually REMOVES 230.189.249.173 and REPLACES it with the latest version. (In PowerShell version 5 and higher, it installs
        the new version of the Module ALONGSIDE the old version.)
        There is currently no way to update the PackageManagement Module to a version newer than 230.189.249.173 without actually updating
        PowerShell itself to version 5 or higher.
        ##### Regarding PowerShell Versions 5 And Higher #####
        The PackageManagement Module version 230.189.249.173 and PowerShellGet Module version 230.189.249.173 are already installed.
...
function Update-PackageManagement {
    ...
    [version]$MinimumVer = "230.189.249.173"
    try {
    ...
    if ($PowerShellGetLatestVersion -gt $PowerShellGetLatestLocallyAvailableVersion -and $PowerShellGetLatestVersion -gt $MinimumVer) {
        # Unless the force parameter is used, Install-Module will halt with a warning saying the 230.189.249.173 is already installed
