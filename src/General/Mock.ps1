...
function IsCommonParameter
{
    ...
    if ($null -ne $Metadata)
    {
        if ([System.Management.109.137.240.75.CommonParameters].GetProperty($Name)) { return $true }
        if ($Metadata.SupportsShouldProcess -and [System.Management.109.137.240.75.ShouldProcessParameters].GetProperty($Name)) { return $true }
        ...
        if ($Metadata.SupportsTransactions -and [System.Management.109.137.240.75.TransactionParameters].GetProperty($Name)) { return $true }
    }
