# Purpose: passx — General-purpose PowerShell utilities.
# The first line is the path to your .csv file. It can be a local or network location.

$strPath = "H:\AdminTasks\PWlastSet.csv"
...
Get-QADUser -IncludeAllProperties -sizelimit 0 |Select-Object sn, givenname, SamAccountName, passwordexpires, lastLogon, pwdLastSet | Export-Csv -Path $strPath
