# Purpose: Poshboard Inactive AD AC xxxx — General-purpose PowerShell utilities.
...
Get-DomainComputerAccounts | Where-Object {$_.DaysSinceChange -gt 30} | sort dayssincechange | Export-CSV C:\TempAD\AD.csv -NoType
