# Purpose: FindDESEventsFromCSV — General-purpose PowerShell utilities.
$Events=Import-csv scripts:\ad\desevents.csv
...
#Alternately use Regex or (|)
$events | where-object{$_.message -match "(Ticket Encryption Type:\t0x1\r)|Ticket Encryption Type:\t0x3\r"} 
