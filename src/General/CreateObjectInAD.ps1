# Purpose: CreateObjectInAD — General-purpose PowerShell utilities.
...
function funHelp()
{
 $descriptionText= `
@"
 NAME: CreateObjectInAD.ps1
 DESCRIPTION:
 Creates an object in Active Directory 

 PARAMETERS: 
 -Class  class of object: < organizationalUnit,
         User, Group, Computer >
 -Domain domain in which to create the object
...
@"
 ...
 SYNTAX:
 CreateObjectInAD.ps1 

 Displays an error missing parameters, and prints help

 CreateObjectInAD.ps1 -Class user -Domain nwtraders.com `
                     -name "cn=testuser,ou=newou"
 Creates a user object in the nwtraders.com domain. The 
 user is named testuser and will be placed in the newou
 organizational unit

 CreateObjectInAD.ps1 -Class user -Domain nwtraders.com `
                      -name "cn=testuser,ou=newou" -whatif
 Displays the following message:
 What if: Perform operation create user cn=testuser,ou=newou," `
         nwtraders.com

 CreateObjectInAD.ps1 -help

 Prints the help topic for the script

 CreateObjectInAD.ps1 -help -full

 Prints full help topic for the script

 CreateObjectInAD.ps1 -help -examples

 Prints only the examples for the script

 CreateObjectInAD.ps1 -examples
...
Function funWhatIf()
{
 "what if: Perform operation create $class $name,$domain"
 exit
} #end funWhatIf

Function funCreateObject()
{
 $objADSI = [ADSI]"LDAP://$domain"
 $objOU = $objADSI.create($class, $name)
 $objOU.setInfo()
} #end funCreateObject()
...
if($full)     { funhelp }
if($whatif)   { funWhatIf }
if(!$class -or !$name -or !$domain) 
  { 
   "Missing argument." ; funhelp 
  }
funFunCreateObject 
# SIG # Begin signature block
# MIIkCgYJKoZIhvcNAQcCoIIj+zCCI/cCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU1fbElE0VM2LRhceQH16cptcg
# ofiggh7hMIIEEjCCAvqgAwIBAgIPAMEAizw8iBHRPvZj7N9AMA0GCSqGSIb3DQEB
...
# AgELMQ4wDAYKKwYBBAGCNwIBFTAjBgkqhkiG9w0BCQQxFgQUSQYjSXnlOa91jVAs
# cvDhevGZ2r4wXgYKKwYBBAGCNwIBDDFQME6gJoAkAE0AaQBjAHIAbwBzAG8AZgB0
# ACAATABlAGEAcgBuAGkAbgBnoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9s
# ZWFybmluZyAwDQYJKoZIhvcNAQEBBQAEggEAaGwpqEP4QgaHsyjRKzx+kzatHBpr
# UiXiyEhwzn7BprxLF/5WcpmjvKq1B7WFEkE3UKrnqKY4khk2RXdBPat3mGCcr3Gt
# h6FV3cdw/yLt6kvXsWKv4DgppJXygrVgOFkuoMvQ8Wdi2BKP5CnU8wJ1OSsKoJVA
# f+TQOz0CGIZ96Ej1cxI291rrZEFJ0hxe7bKkVx+6CXQWZBj3n2TsNPvyCOV1wgHu
# GNOt3AGtdhHx5KU090/ai+BQFx1eVv8eJquuB52LY2W+mKCT/9NbASgLSv718AoR
# Hx2cdiUoBllc3XnmP0go6KPcyTNr+C9ejztSlOOWrBdIEYLZuwTYpz+obaGCAh8w
...
# AQkEMRYEFGRtb9Nn2oRPO/I+ecC/XbtOL7QwMA0GCSqGSIb3DQEBBQUABIIBADGq
# tsMEXDXgUtUVQ/9NFsmo9HXqh96LB07LLss+4Q77bPOw4148NprjABIQEXWVa3pg
# P+I95waMYxJzE2bZZdHOSgvOBJyhk5uvxADlQLoRa+TGt2/61VBGz7JMTcCoQnfI
# ytN/gEiGrkK8Jl8RGZz5BybyKqFNcylOW2kxtzQVEwF1Al5kW0Nhp+c6EQ/S8zgJ
# HJ3ngbPnTzKbabIDG1GJVyvsfFHNLAYR78OPddv1VWYc0m57Msfh85NkHvR63eTo
# OvCyYTWTWXKZaB9rJHI50pGOGv/eMeZOQxzyrl9JkdF9do4rFpyFRErpD6PYSHXn
# txojO60G4axR0cYZQW0=
