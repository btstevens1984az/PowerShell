# Purpose: ServerInfo2CSV2 — General-purpose PowerShell utilities.
# ServerInfo2CSV.PS1
...
$colComputers = get-content C:\BladeLogic\group6install-1.txt
...
# $c.Cells.Item($intRow,15) = $IP.IPaddress[0]
