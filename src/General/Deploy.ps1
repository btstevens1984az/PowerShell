# Purpose: Deploy — General-purpose PowerShell utilities.
#PowerShell Tool for Deploying Scripts
#PowerShell GUI for runnning remote batches/scripts
#Brandon Stevens
#03-11-2018
...
### main ###
import-module "C:\Users\$env:USERNAME\Desktop\BStevensPowerShellGUI\Deploy-master\_Modules\MiCredentialModule"
...
$Form1.text = "username PowerShell GUI | MiShell Deploy | $identity"
...
$RadioButtonnothing.Text = "Null Test"
...
$buttonps.Add_Click( {
		$scope = $combocreds.text
		if ($scope -ne '') {
			$creds = Select-MiCredential -scope $scope -plain
...
#
$host.ui.RawUI.WindowTitle = "username PowerShell Tools | MiShell Deploy | $identity"
write-host ''
