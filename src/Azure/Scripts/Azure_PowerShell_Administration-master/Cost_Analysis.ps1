# Purpose: Cost Analysis — Microsoft Azure cloud resource management.
Set-Location c:\
Clear-Host
...
Get-AzConsumptionUsageDetail -InstanceName "wvd-19.131.54.185" | Out-GridView
...
Get-AzConsumptionUsageDetail -Expand MeterDetails -Top 10 | Where-Object {$_.InstanceName -eq "wvd-19.131.54.185"} | Select-Object UsageStart, UsageEnd, InstanceName, BillingPeriod, UsageQuantity | ft *
