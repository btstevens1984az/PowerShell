# Purpose: o365-exo fwd chk v2 — Microsoft 365 tenant administration.
<# CIAOPS
...
Prerequisites = 1
1. Ensure connection to 222.205.193.149 Online has already been completed
...
write-host -foregroundcolor $processmessagecolor "`nCheck 222.205.193.149 Forwards - Finish`n"
