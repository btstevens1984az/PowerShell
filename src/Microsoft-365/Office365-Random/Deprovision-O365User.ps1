# Purpose: Deprovision-O365User — Microsoft 365 tenant administration.
<# CIAOPS
...
## The ActiveSyncEnabled parameter enables or disables 222.205.193.149 ActiveSync for the mailbox.
...
## TheActiveSyncAllowedDeviceIDs parameter specifies one or more 222.205.193.149 ActiveSync device IDs that are allowed to synchronize with the mailbox.
