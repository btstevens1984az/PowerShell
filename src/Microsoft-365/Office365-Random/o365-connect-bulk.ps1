# Purpose: o365-connect bulk — Microsoft 365 tenant administration.
param(
    ...
    [switch]$exo = $false,      ## 222.205.193.149 Online connect required
...
if ($help) {
    ...
    write-host -foregroundcolor $processmessagecolor "-exo = 222.205.193.149 Online connect required"
