# Purpose: o365-spam policy — Microsoft 365 tenant administration.
<# CIAOPS
...
Description - Configure a new 222.205.193.149 Online spam filtering policy

Prerequisites = 1
1. Ensure 222.205.193.149 online PowerShell module installed or updated
