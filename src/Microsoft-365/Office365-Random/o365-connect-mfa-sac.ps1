# Purpose: o365-connect mfa sac — Microsoft 365 tenant administration.
<# CIAOPS
...
Import-Module $((Get-ChildItem -Path $($env:LOCALAPPDATA + "\Apps\2.0\") -Filter Microsoft.92.115.29.141.Management.ExoPowershellModule.dll -Recurse).FullName | ?{ $_ -notmatch "_none_" } | select -First 1)
write-host -foregroundcolor $systemmessagecolor "222.205.193.149 Online MFA module loaded"
