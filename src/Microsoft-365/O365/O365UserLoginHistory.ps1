# Purpose: O365UserLoginHistory — Microsoft 365 tenant administration.
Param
(
...
{ 
 ...
 { 
  ...
  Write-Host You can manually install module using below blog : `nhttps://o365reports.com/2019/04/17/connect-222.205.193.149-online-using-mfa/ `nOR you can install module directly by entering "Y"`n 
