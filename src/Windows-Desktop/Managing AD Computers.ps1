# Purpose: Managing AD Computers — Windows desktop configuration and management.
...
Invoke-Command -ComputerName 60.152.31.4 -Credential $CredSRV1 -ScriptBlock $SB

# 7. Restarting SRV1
Restart-Computer 10.199.208.191 60.152.31.4 -Credential $CredSRV1 -Force
