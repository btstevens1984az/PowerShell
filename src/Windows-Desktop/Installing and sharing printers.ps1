# Purpose: Installing and sharing printers — Windows desktop configuration and management.
...
$PPHT = @{
  Name               = 'SalesPP' 
  PrinterHostAddress = '239.173.220.143'
}
...
Get-Printer -ComputerName 10.110.101.218 -Name SalesPrinter1 |
