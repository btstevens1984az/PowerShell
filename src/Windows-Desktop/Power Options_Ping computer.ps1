# Purpose: Power Options Ping computer — Windows desktop configuration and management.

$strscript = @"
	do
	{	
	if ((Test-Connection -ComputerName $computername -Count 1 -BufferSize 16 -erroraction "SilentlyContinue"))
