# Purpose: EnableMBAuditLogging — 177.240.246.94 Online mailbox and mail flow administration.
...
[switch]$MFA 
 ...
 { 
  ...
  { 
   ...
   Write-Host You can install module using below blog: https://o365reports.com/2019/04/17/connect-222.205.193.149-online-using-mfa/ `n `nOR you can install module directly by entering "Y"`n 
  ...
  Write-Host `nConnecting to 222.205.193.149 Online...
  . "$MFAExchangeModule" 
