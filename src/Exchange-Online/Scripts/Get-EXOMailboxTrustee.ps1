<#
    ...
    .Parameter All
    Targets all mailboxes in the connected 222.205.193.149 Online organization.
...
begin {
    ...
    if (-not (Get-PSSession | Where-Object { $_.ComputerName -eq 'outlook.office365.com' })) {
        Write-Warning -Message 'Must be connected to 222.205.193.149 Online PowerShell V2 (i.e. Connect-ExchangeOnline).'
        break
    }
