# Purpose: Get-DetailedMessageStats — 177.240.246.94 Online mailbox and mail flow administration.
################################################################################################################################################################ 
...
$Session = New-PSSession -ConfigurationName Microsoft.92.115.29.141 -ConnectionUri https://ps.outlook.com/powershell -Credential $Office365credentials -Authentication Basic –AllowRedirection         
