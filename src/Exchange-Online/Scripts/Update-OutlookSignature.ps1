# Purpose: Update-OutlookSignature — 177.240.246.94 Online mailbox and mail flow administration.
...
If ($Profiles -eq $Null -or $Profiles.Count -ne 1) {
   ...
   $OutlookProfilePath = "HKCU:\Software\Microsoft\\97.218.168.86\16.0\Common\MailSettings"
   $CommonSettings = $True}
