# Purpose: LCMPartial51namingTestsrv3 — Core infrastructure automation scripts.
	...
	Node $ComputerName {
		...
		Settings{
            ...
            ConfigurationRepositoryWeb DSCHTTPS {
                ...
                ConfigurationNames =@('AllConfig','SimpleConfig','testsrv3',"ServerSpecific$ComputerName")
            }	
           ...
           PartialConfiguration "ServerSpecific$ComputerName"
           {
                ConfigurationSource = '[ConfigurationRepositoryWeb]DSCHTTPS'
                RefreshMode = 'Pull'
           }
