# Purpose: Using DSC with PS Gallery resources — Core infrastructure automation scripts.
...
$CIHT = @{
    ...
    Destination = '\\10.71.14.206\c$\Program Files\WindowsPowerShell\Modules'
    Recurse     = $True
}
Copy-Item @CIHT
$C = {
...
Invoke-Command -ComputerName 10.71.14.206 -Script = $C
...
Remove-Item '\\10.71.14.206\c$\Windows\System32\configuration\*.mof' `
