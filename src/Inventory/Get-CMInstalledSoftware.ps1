# Purpose: Get-CMInstalledSoftware — Hardware and software inventory collection.
[CmdletBinding(SupportsShouldProcess=$True)]
    param
        ...
        [Parameter(Mandatory=$False)]
            [switch]$CSV,
        [Parameter(Mandatory=$False)]
            [string]$SQLServer = “1ndcitvwcm01.101.110.227.11”, # eg, <sqlserver>, or <sqlserver>\<instance>
        [Parameter(Mandatory=$False)]
