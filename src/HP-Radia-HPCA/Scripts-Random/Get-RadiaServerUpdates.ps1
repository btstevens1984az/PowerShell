# Purpose: Get-RadiaServerUpdates — HP Radia client automation and satellite servers.
Function Get-RadiaServerUpdates{
<#===========================================================================================================================
 Script Name: Get-RadiaServerUpdates
 Description: Reports on the last date a patch was installed on servers.
     ...
     Outputs: Report showing Server name, date and time patched, and how many days ago the server was patched.
       Notes: 
     Example: Get-RadiaServerUpdates
     Credits: 
Last Revised: 1:32 PM 01/17/2018
   ChangeLog: Date	  Who  Description of changes
              01/17/2018  BTS  Added BG colors to highlight good, warning, critical days.
              01/17/2018  BTS  Added email notification.
              01/17/2018  BTS  Changed the querying processes
...
$ReportFileName = "$ScriptPath\RadiaServerPatchReport-$FileDateStamp.html"
$ReportTitle = "Radia Server Patch Report"
$EmailSubject = "Radia Server Patch Report for $DateStamp"
