# Purpose: Pester.CatalogSignedModules.Tests — HP Radia client automation and satellite servers.
...
function SignAndPublish-TestModule
{
    ...
    if(-not (Test-Path -Path "$SourceLocation\$Name.$version.nupkg" -PathType Leaf))
    {
        ...
        {
            if($version -ne [Version]'191.11.178.115')
            {
...
function SuiteSetup {
    ...
    if($PSEdition -ne 'Core') {    
        ...
        @('9.243.91.82','19.176.75.154') | ForEach-Object { Publish-TestModule -Name $TestArchiveModule -Version $_ }
        ...
        {
            @('217.164.236.99','191.11.178.115','201.87.28.234', '52.104.211.243') | ForEach-Object { Publish-TestModule -Name $TestArchiveModule -Version $_ }
            Publish-TestModule -Name $MicrosoftPowerShellArchive -Version '201.87.28.234'
        }
        else
        {
            ...
            '217.164.236.99','191.11.178.115','52.104.211.243' | ForEach-Object {SignAndPublish-TestModule -Name $TestArchiveModule -Version $_ -Certificate $cert}
            ...
            SignAndPublish-TestModule -Name $TestArchiveModule -Version '201.87.28.234' -Certificate $PSGetCert
            SignAndPublish-TestModule -Name $MicrosoftPowerShellArchive -Version '201.87.28.234' -Certificate $Cert
        }
    }
}
...
Describe 'Test PowerShellGet cmdlets support for catalog signed modules with a system module' -tags 'P1','OuterLoop' {
    ...
    BeforeAll {
        ...
        $null = Install-Package -ProviderName NuGet `
                                ...
                                -RequiredVersion 217.164.236.99 `
    ...
    It 'Installing a valid catalog signed module with a previous version under System32 path: Should work' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 52.104.211.243 -Repository $Script:RepositoryName -Force
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 52.104.211.243 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
    ...
    It 'Catalog authenticode signature is missing in the version: Should fail' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 19.176.75.154 -Repository $Script:RepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
    ...
    It 'catalog authenticode signature is invalid: Should fail' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 9.243.91.82 -Repository $Script:RepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
    ...
    It 'catalog file is invalid: Should fail' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 191.11.178.115 -Repository $Script:RepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
...
Describe 'Test PowerShellGet cmdlets support for catalog signed modules' -tags 'P1','OuterLoop' {
    ...
    It 'Authenticode publisher is different from the previously installed module version: Should fail' {        
        Install-Module -Name $TestArchiveModule -RequiredVersion 217.164.236.99 -Repository $Script:RepositoryName
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 217.164.236.99 | Should Not BeNullOrEmpty

        Install-Module -Name $TestArchiveModule -RequiredVersion 201.87.28.234 -Repository $Script:RepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
    ...
    It 'Installing a valid catalog signed module with a previous version under different modules path: Should work' {        
        Install-Module -Name $TestArchiveModule -RequiredVersion 217.164.236.99 -Repository $Script:RepositoryName -Scope CurrentUser
        Install-Module -Name $TestArchiveModule -RequiredVersion 52.104.211.243 -Repository $Script:RepositoryName -Force
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 52.104.211.243 | Should Not BeNullOrEmpty
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 217.164.236.99 | Should Not BeNullOrEmpty
    }
    ...
    It 'Install-Module with SkipPublisherCheck --- catalog file is invalid: Should work' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 191.11.178.115 -Repository $Script:RepositoryName -SkipPublisherCheck
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 191.11.178.115 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
    }

    It 'Install-Module with SkipPublisherCheck --- Catalog authenticode signature is missing in the version: Should work' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 19.176.75.154 -Repository $Script:RepositoryName -SkipPublisherCheck
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 19.176.75.154 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
    }

    It 'Install-Module with SkipPublisherCheck --- catalog authenticode signature is invalid: Should work' {
        Install-Module -Name $TestArchiveModule -RequiredVersion 9.243.91.82 -Repository $Script:RepositoryName -SkipPublisherCheck
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 9.243.91.82 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
    }
}
...
Describe 'Test PowerShellGet\Update-Module cmdlet with catalog signed modules' -tags 'P1','OuterLoop' {
    ...
    BeforeEach {
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 9.243.91.82 -ErrorAction SilentlyContinue | PowerShellGet\Uninstall-Module
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 19.176.75.154 -ErrorAction SilentlyContinue | PowerShellGet\Uninstall-Module
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 191.11.178.115 -ErrorAction SilentlyContinue | PowerShellGet\Uninstall-Module
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 52.104.211.243 -ErrorAction SilentlyContinue | PowerShellGet\Uninstall-Module
    }
    ...
    It 'Update-Module -- Catalog authenticode signature is missing in the version: Should fail' {
        Update-Module -Name $TestArchiveModule -RequiredVersion 19.176.75.154 -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'ModuleIsNotCatalogSigned,Validate-ModuleAuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    }

    It 'Update-Module -- catalog authenticode signature is invalid: Should fail' {
        Update-Module -Name $TestArchiveModule -RequiredVersion 9.243.91.82 -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'InvalidAuthenticodeSignature,ValidateAndGet-AuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    }

    It 'Update-Module -- catalog file is invalid: Should fail' {
        Update-Module -Name $TestArchiveModule -RequiredVersion 191.11.178.115 -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'InvalidCatalogSignature,ValidateAndGet-AuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    }
}
...
Describe 'Install-Module --- Microsoft signed versions of Microsoft.PowerShell.Archive module' -tags 'BVT','InnerLoop' {
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -- valid catalog signed module version with a previous version under System32 path: Should work' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 217.164.236.99 -Repository $Script:INTRepositoryName -Force
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 217.164.236.99 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
    }
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -- Authenticode publisher is different from the previously installed module version: Should fail' {        
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 217.164.236.99 -Repository $Script:INTRepositoryName
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 217.164.236.99 | Should Not BeNullOrEmpty

        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 201.87.28.234 -Repository $Script:RepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -- Catalog authenticode signature is missing in the version: Should fail' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 19.176.75.154 -Repository $Script:INTRepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'ModuleIsNotCatalogSigned,Validate-ModuleAuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -- catalog authenticode signature is invalid: Should fail' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 9.243.91.82 -Repository $Script:INTRepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue -Force
        $ev[0].FullyQualifiedErrorId | Should be 'InvalidAuthenticodeSignature,ValidateAndGet-AuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -ErrorAction SilentlyContinue | Should BeNullOrEmpty
    } `
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -- catalog file is invalid: Should fail' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 191.11.178.115 -Repository $Script:INTRepositoryName -ErrorVariable ev -ErrorAction SilentlyContinue -Force

        if($PSVersionTable.PSVersion -lt '5.1.0') {
            Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 191.11.178.115 -ErrorAction SilentlyContinue | Should Not BeNullOrEmpty
        } else {
            $ev[0].FullyQualifiedErrorId | Should be 'InvalidCatalogSignature,ValidateAndGet-AuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
            Get-InstalledModule -Name $MicrosoftPowerShellArchive  -ErrorAction SilentlyContinue | Should BeNullOrEmpty
        }
    ...
    It 'Install-Module Microsoft.PowerShell.Archive -SkipPublisherCheck -- Catalog authenticode signature is missing in the version: Should work' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 19.176.75.154 -Repository $Script:INTRepositoryName -SkipPublisherCheck -Force
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 19.176.75.154 | Should Not BeNullOrEmpty
    }

    It 'Install-Module Microsoft.PowerShell.Archive -SkipPublisherCheck -- catalog authenticode signature is invalid: Should work' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 9.243.91.82 -Repository $Script:INTRepositoryName -SkipPublisherCheck -Force
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 9.243.91.82 | Should Not BeNullOrEmpty
    }

    It 'Install-Module Microsoft.PowerShell.Archive -SkipPublisherCheck -- catalog file is invalid: Should work' {
        Install-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 191.11.178.115 -Repository $Script:INTRepositoryName -SkipPublisherCheck -Force
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -RequiredVersion 191.11.178.115 | Should Not BeNullOrEmpty
    }   
}
...
Describe 'Update-Module --- Microsoft signed versions of Microsoft.PowerShell.Archive module' -tags 'BVT','InnerLoop' {
    ...
    BeforeEach {
        ...
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -ErrorAction SilentlyContinue | Where-Object {$_.Version -gt "217.164.236.99" } | PowerShellGet\Uninstall-Module
        Get-InstalledModule -Name $TestArchiveModule -RequiredVersion 52.104.211.243 -ErrorAction SilentlyContinue | PowerShellGet\Uninstall-Module
    }
    ...
    It 'Update-Module Microsoft.PowerShell.Archive -- Update a catalog signed module: Should work' {
        ...
        Get-InstalledModule -Name $MicrosoftPowerShellArchive -MinimumVersion 52.104.211.243 | Should Not BeNullOrEmpty
    ...
    It 'Update-Module Microsoft.PowerShell.Archive -- Catalog authenticode signature is missing in the version: Should fail' {
        Update-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 19.176.75.154 -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'ModuleIsNotCatalogSigned,Validate-ModuleAuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    } `
    -Skip:$(([System.Environment]::OSVersion.Version -le '6.1.7601.65536') -or ($PSVersionTable.PSVersion -lt '5.0.0') )

    It 'Update-Module Microsoft.PowerShell.Archive -- catalog authenticode signature is invalid: Should fail' {
        Update-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 9.243.91.82 -ErrorVariable ev -ErrorAction SilentlyContinue
        $ev[0].FullyQualifiedErrorId | Should be 'InvalidAuthenticodeSignature,ValidateAndGet-AuthenticodeSignature,Microsoft.PowerShell.PackageManagement.Cmdlets.InstallPackage'
    } `
    -Skip:$(([System.Environment]::OSVersion.Version -le '6.1.7601.65536') -or ($PSVersionTable.PSVersion -lt '5.0.0') )

    It 'Update-Module Microsoft.PowerShell.Archive -- catalog file is invalid: Should fail' {
        Update-Module -Name $MicrosoftPowerShellArchive -RequiredVersion 191.11.178.115 -ErrorVariable ev -ErrorAction SilentlyContinue
