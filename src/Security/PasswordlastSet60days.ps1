# Purpose: PasswordlastSet60days — Security auditing and compliance checks.
# powershell2
...
$obj | Add-Member NoteProperty logonName($account.Properties["logonName"][0]);
...
Get-DomainUserAccounts | Where-Object {$_.DaysSinceChange -gt 60} | sort dayssincechange | Export-CSV H:\AD-Reports\PasswordlastSetGreaterThan60days-AD.csv
