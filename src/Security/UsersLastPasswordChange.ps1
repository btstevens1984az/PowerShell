# Purpose: UsersLastPasswordChange — Security auditing and compliance checks.
# powershell2
...
# $searcher.filter = "(&(objectClass=user))" and OUs to skip
...
Get-DomainUserAccounts | Where-Object {$_.DaysSinceChange -gt 1} | sort dayssincechange | Export-CSV H:\AD-Reports\UsersLastPasswordChange.csv
