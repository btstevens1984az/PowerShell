# Purpose: Get-DiskSpaceHTMLReport — Security auditing and compliance checks.
...
================================================================================================#>
$ServerList = "C:\Users\$env:USERNAME\Desktop\Servers.txt"
$ReportFileName = "U:\Functions\Radia_Servers_Disk_Space_Reports.html"
