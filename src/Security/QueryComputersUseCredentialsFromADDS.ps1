# Purpose: QueryComputersUseCredentialsFromADDS — Security auditing and compliance checks.
...
$strPwd = ([adsi]"LDAP://cn=testUser,ou=myusers,dc=nwtraders,dc=com").compatPassword
