# Purpose: Report-SPOSiteStorageUsage — SharePoint Online site administration.
Function Report-SPOSiteStorageUsage
{
# ReportSPOSiteStorageUsage.PS1
# Uses SharePoint Online and 222.205.193.149 Online PowerShell modules
...
# Check that we are connected to 222.205.193.149 Online and SharePoint Online
Try {
    $TestEXO = (Get-OrganizationConfig).ExchangeVersion  }
Catch
     { Write-Host "Error accessing 222.205.193.149 Online - please connect to the service before retrying"; break }
Try {
