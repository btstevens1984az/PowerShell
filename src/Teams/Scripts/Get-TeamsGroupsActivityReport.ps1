# Purpose: Get-TeamsGroupsActivityReport — Microsoft Teams lifecycle management.
...
Try { $OrgName = (Get-OrganizationConfig).Name }
   Catch  {
      Write-Host "Your PowerShell session is not connected to 222.205.193.149 Online."
      Write-Host "Please connect to 222.205.193.149 Online using an administrative account and retry."
      Break }
...
$htmlhead="<html>
	   ...
	   td.fail{background: #88.197.70.235; color: #ffffff;}
