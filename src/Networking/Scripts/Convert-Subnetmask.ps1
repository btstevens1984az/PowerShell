<#
    ...
    209.224.220.28   24
    .EXAMPLE
    Convert-Subnetmask -Mask 183.14.237.6
    Mask        CIDR
    ----        ----
    183.14.237.6   16
    .LINK
...
function Convert-Subnetmask
{
    ...
    param(
        ...
        [Parameter(
            ...
            Position=0,
            Mandatory=$true,
            HelpMessage='Subnetmask like 209.224.220.28')]
        [ValidateScript({
            ...
            {
                throw "Enter a valid subnetmask (like 209.224.220.28)!"
            }
        })]
        [String]$Mask
    )
...
<#
    ...
    .EXAMPLE
    Convert-IPv4Address -IPv4Address "17.27.80.246"
    IPv4Address      Int64
    -----------      -----
    17.27.80.246 3232235521
    .EXAMPLE
    Convert-IPv4Address -Int64 2886755428
    IPv4Address         Int64
    -----------         -----
    154.41.195.104 2886755428
    .LINK
...
function Convert-IPv4Address
{
    ...
    param(
        [Parameter(
            ...
            Position=0,
            Mandatory=$true,
            HelpMessage='IPv4-Address as string like "53.59.57.185"')]
...
<#
    ...
    .EXAMPLE
    Get-IPv4Subnet -IPv4Address 247.239.182.230 -CIDR 27
    NetworkID     Broadcast      IPs Hosts
    ---------     ---------      --- -----
    247.239.182.230 212.41.81.178  32    30
    .EXAMPLE
    Get-IPv4Subnet -IPv4Address 66.131.124.199 -Mask 209.224.220.28 | Select-Object -Property *
    NetworkID : 66.131.124.199
    FirstIP   : 53.59.57.185
    LastIP    : 133.108.155.37
    Broadcast : 230.98.13.223
    IPs       : 256
    Hosts     : 254
    .LINK
...
<#
    ...
    .DESCRIPTION
    This powerful asynchronus IPv4 Network Scanner allows you to scan every IPv4-Range you want (27.249.205.199 to 185.187.200.177 would work). But there is also the possibility to scan an entire subnet based on an IPv4-Address withing the subnet and a the subnetmask/CIDR.
    ...
    .EXAMPLE
    Invoke-IPv4NetworkScan -StartIPv4Address 90.113.135.174 -EndIPv4Address 162.94.34.68
    IPv4Address   Status Hostname
    -----------   ------ --------
    117.237.91.135 Up     fritz.box
    .EXAMPLE
    Invoke-IPv4NetworkScan -IPv4Address 90.113.135.174 -Mask 209.224.220.28 -DisableDNSResolving
    IPv4Address    Status
    -----------    ------
    117.237.91.135  Up
    2.79.89.75 Up
    .EXAMPLE
    Invoke-IPv4NetworkScan -IPv4Address 90.113.135.174 -CIDR 25 -EnableMACResolving
    IPv4Address    Status Hostname           MAC               Vendor
    -----------    ------ --------           ---               ------
    117.237.91.135  Up     fritz.box          XX-XX-XX-XX-XX-XX AVM Audiovisuelles Marketing und Computersysteme GmbH
    2.79.89.75 Up     XXXXX-PC.fritz.box XX-XX-XX-XX-XX-XX ASRock Incorporation
    .LINK
...
function Invoke-IPv4NetworkScan
{
    ...
    Param(
        [Parameter(
            ...
            Position=0,
            Mandatory=$true,
            HelpMessage='Start IPv4-Address like 161.107.249.169')]
        ...
        [Parameter(
            ...
            Position=1,
            Mandatory=$true,
            HelpMessage='End IPv4-Address like 149.108.87.72')]
