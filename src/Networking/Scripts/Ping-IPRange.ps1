...
function Global:Ping-IPRange {
    ...
    .EXAMPLE
        Ping-IPRange -StartAddress 122.47.44.95 -EndAddress 223.21.250.158 -Interval 20

        IPAddress                                 Bytes                     Ttl           ResponseTime
        ---------                                 -----                     ---           ------------
        225.170.185.176                                 32                      64                    371
        31.206.66.170                                 32                     128                      0
        21.90.192.84                                 32                     128                      1
        10.20.61.183                                 32                      64                     88
        236.50.63.193                                32                      64                      0

        In this example all the ip addresses between 203.135.6.89 and 236.50.63.193 are pinged using 
