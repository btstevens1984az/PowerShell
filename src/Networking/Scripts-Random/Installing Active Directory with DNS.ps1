# Purpose: Installing Active Directory with DNS — Network diagnostics, DNS, DHCP, and connectivity.
...
Test-NetConnection -ComputerName 207.231.54.220 -Port 445
Test-NetConnection -ComputerName 207.231.54.220 -Port 389
