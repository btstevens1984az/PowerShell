# Purpose: ImportDrivers — Network diagnostics, DNS, DHCP, and connectivity.
...
Import-SCCMDriverStore "\\192.179.149.99\sccm_store\OSD\DriverSources" "\\192.179.149.99\sccm_store\OSD\DriverPackages"
