# Purpose: SimpleFileConfigPullCredClear — Storage management and disk operations.
    ...
    param(
     ...
     Node $computerName {
        ...
        group localadmin{
            ...
            MembersToInclude = "Kayloslab\jeff"
