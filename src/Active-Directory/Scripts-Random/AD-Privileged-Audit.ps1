# Purpose: AD-Privileged Audit — Active Directory user, group, and domain administration.
...
function Invoke-ADPrivGroups($ctx){
	...
	# - https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-216.35.234.227-r2-and-2012/dn579255(v=ws.11)
