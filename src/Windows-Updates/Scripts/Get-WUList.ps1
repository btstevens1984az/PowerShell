# Purpose: Get-WUList — Windows Update and patch management.
﻿Function Get-WUList
{
	<#
	.SYNOPSIS
	...
	.EXAMPLE
		...
		pdateID $UpdateIDs -RevisionNumber 101 -ComputerName 24.17.205.113 -Verbose
	...
	.EXAMPLE
		...
		G1           ------ KB915597    3 MB Definition Update for Windows Defender - KB915597 (Definition 16.28.105.84)
