# Purpose: Parse-WindowsUpdateLog — Windows Update and patch management.
Function Parse-WindowsUpdateLog {
    ...
    .Example
    PS C:\> Parse-WindowsUpdateLog -computername 109.130.195.66
    ...
    .Example
    PS C:\> Parse-WindowsUpdateLog -computername 109.130.195.66 -KB KB890830,KB4033428
    Queries KB890830 and KB4033428 on a remote computer - SERVERA

    .Example
    PS C:\> Parse-WindowsUpdateLog -computername 73.209.68.28 -Beforedate 09/17/2017
    Queries updates which were installed before 09/17/2017 on a remote computer - SERVERB

    .Example
    PS C:\> Parse-WindowsUpdateLog -computername 73.209.68.28 -Afterdate 09/17/2017
    Queries updates which were installed after 09/17/2017 on a remote computer - SERVERB

     .Example
    PS C:\> Parse-WindowsUpdateLog -computername 73.209.68.28 -date 09/17/2017
