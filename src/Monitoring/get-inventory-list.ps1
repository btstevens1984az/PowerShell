# Purpose: get-inventory list — System monitoring and alerting.
# powershell2
# get-inventory-list.ps1
# Create a new Excel object using COM
$Excel = New-Object -ComObject Excel.Application
$Excel.visible = $True
$Excel.SheetsInNewWorkbook = @(get-content "C:\uninstall\allcomps.txt").count

#Counter variable for rows
$i = 1

#Read thru the contents of the Servers.txt file
foreach ($server in get-content "C:\uninstall\allcomps.txt")
{
