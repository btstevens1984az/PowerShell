function Set-GhostLicensingConfig {
    <#
    .SYNOPSIS
        Updates M365-GhostLicensing configuration for the current session.
    ...
    if ($PSCmdlet.ShouldProcess('M365-GhostLicensing configuration', 'Update')) {
        ...
        Write-GhostLicensingAudit -Action 'Set-GhostLicensingConfig' -Data @{
