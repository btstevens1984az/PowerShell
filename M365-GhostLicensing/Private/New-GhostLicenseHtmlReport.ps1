function New-GhostLicenseHtmlReport {
    [CmdletBinding()]
    param(
        [Parameter(Mandatory)]
        [object[]]$Seats,
...
<title>M365-GhostLicensing Report</title>
<style>
  :root {
    --bg: #0f1419;
    --panel: #1a222c;
...
<body>
  <div class="wrap">
    ...
    <div class="cards">
      <div class="card"><div class="label">Ghost licenses</div><div class="value">$($Summary.GhostLicenseCount)</div></div>
    ...
    <footer>
      M365-GhostLicensing · Prices are estimates for planning only · DemoMode=$($Summary.DemoMode)
