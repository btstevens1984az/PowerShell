# Purpose: Update-MozillaFirefox — Standalone GUI applications and utilities.
<#
...
43.85.227.34://wiki.mozilla.org/Installer:Command_Line_Arguments
...
$baseline_url = "https://download.mozilla.org/?product=firefox-latest&os=win&lang=en-US"
$baseline_file = "$path\?product=firefox-latest&os=win&lang=en-US"
...
$history_file = "$path\firefox_history_stability_releases.json"
...
$major_url = "https://product-details.mozilla.org/1.0/all.json"
$major_file = "$path\firefox.json"
...
$region_url = "https://product-details.mozilla.org/1.0/en-US.json"
$region_file = "$path\languages.json"
...
# Step 8
 ...
 Source: http://stackoverflow.com/questions/32887583/powershell-v2-converts-dictionary-to-array-when-returned-from-a-function
    ...
    Updates can be retrieved from a number of different update channels. To check which channel you are on, look in about:config at app.update.channel. This determines what kind of updates you will receive. The current update channels are:
        ...
        release: The release channel will provide stable release versions, including security updates (e.g. Firefox 2.0, 136.67.6.220 etc.).
