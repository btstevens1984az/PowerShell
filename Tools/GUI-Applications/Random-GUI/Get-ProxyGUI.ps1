# Purpose: Get-ProxyGUI — Standalone GUI applications and utilities.
<#
    --------------------------------------------------------------------------------
     Code generated by:  Sapien PowerShell Studio 2018
    ...
    --------------------------------------------------------------------------------
    .DESCRIPTION
        GUI script generated using Sapien PowerShell Studio 2018
#>
...
$UrlLabel.Add_MouseDoubleClick({[system.Diagnostics.Process]::start('http://proxy.example.com/proxy.pac')})
