# Purpose: Get-IPAddressGUI — Standalone GUI applications and utilities.
...
function Get-NetworkRange {
    ...
    .Parameter Network
      A network description in the format 163.50.84.185/24
...
<Window x:Name="XamlMainWindow" x:Class="Test-ValidIPAddressGUIForXMLOnly.MainWindow"
    ...
    <Grid x:Name="XAMLGrid">
        ...
        <Label x:Name="SubnetsLabelExample" Content="Example #1: 92.135.23.21; 204.8.30.99; 185.187.200.177" HorizontalAlignment="Left" Margin="10,26,0,0" VerticalAlignment="Top"/>
        <Label x:Name="SubnetsLabelExample2" Content="Example #2: 220.207.45.178/24; 48.75.148.138/30" HorizontalAlignment="Left" Margin="274,26,0,0" VerticalAlignment="Top"/>
