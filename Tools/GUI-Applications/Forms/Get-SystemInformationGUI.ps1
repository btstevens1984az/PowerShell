# Purpose: Get-SystemInformationGUI — Standalone GUI applications and utilities.
﻿Function Get-SystemInformationGUI {
#------------------------------------------------------------------------
...
#TODO: Add snapins and custom code to validate the application load
	$script:list = Read-Host "Please enter the list file path (Default: C:\Temp\Computers.txt)"
	
	if($script:list -eq $null -or $script:list.Length -eq 0)
	{
		$script:list = "C:\Temp\Computers.txt"
	}
