# Purpose: Get-ComputerInventoryExcelReport — McAfee ePolicy Orchestrator reporting.
Function Get-ComputerInventoryExcelReport {
clear
$Host.UI.RawUI.WindowTitle = "System Inventory Tool Designed by Brandon Stevens"
Write-Host `n
Write-Host Author: Brandon Stevens -BackgroundColor black -ForegroundColor white
Write-Host `n
