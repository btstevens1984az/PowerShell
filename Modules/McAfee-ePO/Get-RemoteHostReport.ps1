<#
    .SYNOPSIS
        Get-RemoteHostReport - Creates detailed reports of one or more computer systems.
    ...
    .EXAMPLE
        ...
        .\Get-RemoteHostReport.ps1 -Computers $Servers -PromptForCredentials -Verbose
        ...
        1.5 - 01/17/2014
            ...
            - Get-RemoteHostReport now stores the Assetnames defined in the configuration section of the data structure
        1.4 - 11/07/2013
...
"@
  ...
  Function Get-RemoteHostReport
  {
    <#
        ...
        $cred = get-credential
        Get-RemoteHostReport -AssetName $Computers `
  ...
  Get-RemoteHostReport @reportsplat
