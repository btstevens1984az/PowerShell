# Purpose: Get-AdobeFlashVersionInstalled — Active Directory user, group, and domain administration.
Function Get-AdobeFlashVersionInstalled
{
    <#  
        .SYNOPSIS
        ...
        .EXAMPLE
            Get-AdobeFlashVersionInstalled
