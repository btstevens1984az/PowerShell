# Purpose: Set-OwnershipOfFileOrFolder — Storage management and disk operations.
Function Set-OwnershipOfFileOrFolder {
    <#
        .SYNOPSIS
        ...
        .EXAMPLE
            Set-Owner -Path C:\temp\test.txt -Account 'Domain\username
            Description
            -----------
            Changes the owner of test.txt to Domain\username
        .EXAMPLE
        ...
        .EXAMPLE
            Get-ChildItem C:\Temp | Set-Owner -Recurse -Account 'Domain\username'
            Description
            -----------
            Changes the owner of all files and folders under C:\Temp to Domain\username
    #>
    [cmdletbinding(
