# Purpose: Get-ComputersInfoGUI — Windows desktop configuration and management.
Function Get-ComputersInfoGUI {
...
$txtComputerList.Text = 'C:\Users\$env:USERNAME\Desktop\Computers.txt' 
