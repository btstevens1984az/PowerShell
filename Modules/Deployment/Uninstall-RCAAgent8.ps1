# Purpose: Uninstall-RCAAgent8 — Reusable PowerShell function libraries.
Function Uninstall-RCAAgent8 {
[CmdletBinding()]
$remove = @('*Radia Client Automation Application Manager Agent*')
