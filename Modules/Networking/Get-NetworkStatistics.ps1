# Purpose: Get-NetworkStatistics — Network diagnostics, DNS, DHCP, and connectivity.
function Get-NetworkStatistics {
    ...
    .PARAMETER ComputerName
        If defined, run this command on a remote system via WMI.  \\253.155.212.58\c$\netstat.txt is created on that system and the results returned here
    ...
    .EXAMPLE
	    Get-NetworkStatistics iexplore -computername 21.83.199.129 -ShowHostNames | Format-Table
    ...
    .EXAMPLE
        Get-NetworkStatistics -Computername 213.178.182.248, Computer2
