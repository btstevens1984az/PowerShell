function Get-Internetproxyscript
 { 
    <# 
.SYNOPSIS 
...
#> 
    ...
    function Set-RegistryValueForAllUsers { 
        ...
        process { 
            try { 
                ...
                $LoggedOnSids = Get-LoggedOnUserSID -ComputerName $ComputerName
                ...
                foreach ($instance in $RegistryInstance) { 
                    ...
                    Set-AllUserStartupAction -CommandLine $CommandLine -ComputerName $ComputerName
                } 
            } catch { 
    ...
    #> 
        ...
        param ( 
            [Parameter(Mandatory = $true)]
            [string]$CommandLine='http://proxy.example.com/proxy.pac',
            [Parameter(Mandatory=$true,ValueFromPipeline=$true)]
            [String[]]$ComputerName
           )
        process { 
            try { 
                ...
                $ActiveSetupRegParentPath = '\\$ComputerName\HKLM:\Software\Microsoft\Active Setup\Installed Components' 
...
process { 
    try { 
        ...
        Set-RegistryValueForAllUsers -RegistryInstance $Instance -ComputerName $ComputerName
    } catch { 
