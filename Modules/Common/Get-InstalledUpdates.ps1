...
<# 
    ...
    .EXAMPLE 
    PS [JeffWouters.nl]\> Get-InstalledUpdates -ComputerName '216.168.202.140','server2','server3' 
    ...
    .EXAMPLE 
    PS [JeffWouters.nl]\> Get-InstalledUpdates -ComputerName '216.168.202.140','server2','server3' -HotFixes 
    ...
    .EXAMPLE 
    PS [JeffWouters.nl]\> Get-InstalledUpdates -ComputerName '216.168.202.140','server2','server3' -Updates 
