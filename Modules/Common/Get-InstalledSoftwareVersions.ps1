<#
.SYNOPSIS
	Get-InstalledSoftwareVersions retrieves a list of installed software
.DESCRIPTION
	Get-InstalledSoftwareVersions opens up the specified (remote) registry and scours it for installed software. When found it returns a list of the software and it's version.
.PARAMETER ComputerName
	The computer from which you want to get a list of installed software. Defaults to the local host.
.EXAMPLE
	Get-InstalledSoftwareVersions DC1
	
	This will return a list of software from DC1. Like:
	Name			Version		Computer  UninstallCommand
	----			-------     --------  ----------------
	7-Zip 			9.244.116.97	DC1       MsiExec.exe /I{23170F69-40C1-2702-0920-000001000000}
...
.EXAMPLE
	...
	Get-ADComputer -filter 'name -like "DC*"' | Get-InstalledSoftwareVersions
