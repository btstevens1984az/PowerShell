# Purpose: Start-MyDashboardLocalhost — Reusable PowerShell function libraries.
<#PSScriptInfo 
...
#$cert = Set-UDLicense -License "<License><Terms></Terms><Signature>HZKgTUvKtPHesVw5Oj6b//icGbML+89dRYRUCeeFpEu+0/fdVSNzvQ==</Signature></License>"
Function Start-MyDashboardLocalhost {
Stop-UDDashboard -Name dashboard0
  Start-UdDashboard -Content {
    New-UdDashboard -Title "Server Performance Dashboard" -Color '#FF050F7F' -Content {
        New-UdRow {
          ...
          } Start-UDDashboard -Name dashboard0