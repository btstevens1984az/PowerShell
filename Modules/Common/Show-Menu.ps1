# Purpose: Show-Menu — Reusable PowerShell function libraries.
function Show-Menu{ 
{ 
 
 
     param ( 
           [string]$Title = 'Welcome to the Patch Monitor!' 
     ) 
     cls 
     Write-Host "=====$Title =====" 
     Write-Host "                   " 
      
     Write-Host "Using this script , you can get the details of patch installation in multiple servers." 
     Write-Host "                   " 
     Write-Host "The script will capture Hotfix numbers, Hotfix type, Date installed, Installed By, and Uptime." 
     Write-Host "       " 
     Write-Host "It also captures all automatic services which are not running." 
     Write-Host "                   " 
     Write-Host "Test before you use in production. Must use Powershell 4.0 or higher." 
     Write-Host "                   " 
