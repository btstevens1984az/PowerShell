# Purpose: Add-PoShEndpointAccess — Reusable PowerShell function libraries.
...
function Add-PoShEndpointAccess
{
    ...
    .EXAMPLE
       Add-PoShEndpointAccess -SamAccountName "contoso\PoShUsers" -ComputerName 242.161.83.110
    #>
