...
.Example
    ...
    "Invoke-SqlQuery -Query SELECT DISTINCT [device_id]
      ,[ctime]
      ,[mtime]
      ,[duration]
      ,[adddone]
      ...
      ,[zcontext]
      ,[zuserid]
  FROM [RCA_CORE].[dbo].[DeviceSynopsis]"

#>
Function Get-DeviceSynopsysTable {
    [CmdletBinding()]
...
Set-Alias -Name GDST -Value Get-DeviceSynopsysTable
Export-ModuleMember -Function Get-DeviceSynopsysTable -Alias GDST