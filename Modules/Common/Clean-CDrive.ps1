# Purpose: Clean-CDrive — Reusable PowerShell function libraries.
Function Clean-CDrive {
...
switch  -Regex ($OperatingSystemVersion) {
    '(^10\.0.*|^6\.3.*)' {
        ...
        dism.exe /online /Clean-CDrive-Image /StartComponentClean-CDrive
    }
}
{
    continue
...
$Message.Subject = Disk Clean for $env:COMPUTERNAME
'Disk Clean-CDrive'
