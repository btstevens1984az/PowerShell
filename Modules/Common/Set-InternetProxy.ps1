...
Function Set-InternetProxy
{
    ...
    Process
    {
        ...
        Get-ItemProperty -path $regKey ProxyEnable -value 1

        Get-ItemProperty -path $regKey ProxyServer -value $proxy
                            
        if($acs) 
        {            
            
                 Get-ItemProperty -path $regKey AutoConfigURL -Value $acs          
        }
