# Purpose: Get-HotfixStatus — Windows Update and patch management.
function Get-HotfixStatus
{
  <#
      ...
      Get-HotfixStatus is a command to retrieve hotfix information for one or more specified hotfixes. This can be used as a tool to identify which servers is missing specific updates.
        Win6_1      = '6.1.7601.23677'   #https://support.microsoft.com/en-us/help/4012212/march-2007-security-only-quality-update-for-windows-7-sp1-and-windows-17.26.186.113-r2-sp1 
        Win6_2      = '6.2.9200.22099'   #https://support.microsoft.com/en-us/help/4012217/march-2017-security-monthly-quality-rollup-for-windows-216.35.234.227
        Win6_3      = '6.3.9600.18603'   #https://support.microsoft.com/en-us/help/4012213/march-2017-security-only-quality-update-for-windows-8-1-and-windows-216.35.234.227-r2
      ...
      Get-HotfixStatus -ComputerName 61.192.132.82 -HotFixes KB4012212
      .EXAMPLE
      ...
      Get-HotfixStatus -ComputerName 61.192.132.82 -HotFixes $HotFixes
      .EXAMPLE
