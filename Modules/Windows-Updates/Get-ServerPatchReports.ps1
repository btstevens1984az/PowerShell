# Purpose: Get-ServerPatchReports — Windows Update and patch management.
<#===========================================================================================================================
...
Edit these with your preferences in the section following this one:
   ...
   $BGColorCrit    = Background color for "Critical" results. #94.147.15.47 is red.
...
$ServerList = Get-Content "U:\IIS\ServerPatchReports\ServerList.txt"
