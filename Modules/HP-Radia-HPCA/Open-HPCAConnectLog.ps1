# Purpose: Open-HPCAConnectLog — HP Radia client automation and satellite servers.
function Open-HPCAConnectLog{
    param
    (
    ...
    { 
        ...
        Invoke-Item "\\$ComputerName\c$\Program Files (x86)\Hewlett-Packard\HPCA\Agent\Log\connect_Patch.log" -ErrorAction SilentlyContinue
